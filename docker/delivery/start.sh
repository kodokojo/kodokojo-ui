...
cat /var/config/config.template.tpl | sed -e "s#@@RECAPTCHA@@#$RECAPTCHA_ENV#g" -e "s#@@TOS@@#$TOS_ENV#g" -e "s#@@WAITING_LIST@@#$WAITING_LIST_ENV#g" -e "s#@@CRISP@@#$CRISP_ENV#g" > /var/www/assets/json/ui.configuration.json
